...
struct Snapshot {
    ...
    std::int32_t battery_current_average_ma = 0;
    std::uint32_t battery_current_sample_count = 0;
...
private:
    ...
    std::int64_t battery_current_sum_ma_ = 0;
    std::uint32_t battery_current_sample_count_ = 0;
